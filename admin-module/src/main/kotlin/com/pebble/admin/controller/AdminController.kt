...
class AdminController(
    ...
    fun applyPenalty(
        @AuthenticationPrincipal jwt: Jwt,
        @PathVariable userId: Long,
        @RequestBody request: com.pebble.admin.dto.PenaltyRequest
    ): ResponseEntity<Void> {
        val adminId = jwt.subject.toLongOrNull() ?: throw IllegalArgumentException("유효하지 않은 관리자 ID입니다.")
        adminService.applyPenalty(adminId, userId, request, jwt.tokenValue)
